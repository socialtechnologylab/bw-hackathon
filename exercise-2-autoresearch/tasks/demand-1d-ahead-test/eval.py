"""Autoresearch baseline for demand-1d-ahead-test.

Usage (from this directory):
    uv run python eval.py

Or from the repo root:
    uv run python tasks/demand-1d-ahead-test/eval.py
...
HERE = Path(__file__).resolve().parent          # tasks/demand-1d-ahead-test/
REPO_ROOT = HERE.parent.parent
DATA_DIR = HERE / "data"

load_dotenv(REPO_ROOT / ".env")

TASK_ID = "demand-1d-ahead-test"
TARGET = "demand_mwh"
FEATURES = [
    "ghi_fcst",
    "t2m_fcst",
